...
public class AutoBall4 {
    public enum autoRun {
        INIT, LINEAR1, LINEUP1, SHOOT1, PIVOT1, LINEAR2, LINEAR3, SHOOT2, DONE;
    }
    ...
    public void run(){
        ...
        switch(AutoState1){
            ...
            case LINEUP1:
                ...
                else if (Timer.getFPGATimestamp() - PrevTime > 0.25)
            ...
            case DONE:
                if (Timer.getFPGATimestamp() < PrevTime + 0.2)
                    mechMaster.autoRun(autoMech.SHOOT, turretMech.SET, 0);
                else
