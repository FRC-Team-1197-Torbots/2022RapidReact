...
public class AutoBall4 {
    public enum autoRun {
        INIT, LINEAR1, SHOOT1, PIVOT1, LINEAR2, LINEAR3, SHOOT2, DONE;
    }
...
private autoRun AutoState1 = autoRun.INIT;
    ...
    public AutoBall4(MechMaster mechMaster, TorDrive torDrive){
        ...
        linear1 = new linearTrajectory2(torDrive, 4.0, 2); //4.0 2.5
        pivot1 = new pivotTrajectory(torDrive, 10, 0.75);
        linear2 = new linearTrajectory2(torDrive, 12.67, 4.0); //4.0 //3.5

        linear3 = new linearTrajectoryBack(torDrive, -4, 20); //-6 1.5 //-4, 1.0 //1.75 original
    ...
    public void run(){
        ...
        switch(AutoState1){
            ...
            case SHOOT2:
                if(Timer.getFPGATimestamp() - PrevTime < 1.25) {
                    mechMaster.autoRun(autoMech.IDLE, turretMech.SET, 170);
                } else {
                    mechMaster.autoRun(autoMech.SHOOT, turretMech.AUTOAIM, 0);
                }
